# **2014: Child Development** **Supplement - Time Diary Media** **Codes File** **Codebook**
...
```
    Monday December 3 2018 12:12 PM

```

```
        2014: Child Development Supplement - Time Diary Media Codes File

TD14M01  "RELEASE NUMBER 14"                  NUM(1.0)
...
```
TD14M02  "2013 INTERVIEW NUMBER"                NUM(5.0)
2013 PSID Main Family Identifier

The values for this variable represent the 2013 interview number of the family in which
this individual was included in CDS-2014.
...
```
TD14M03  "2013 SEQUENCE NUMBER"                NUM(2.0)
2013 PSID Sequence Number
...
time of the 2013 main family interview
...
```
TD14M04  "TYPE OF DIARY 14"                  NUM(1.0)
...
TD14M07  "ACTIVITY CODE 14"                  NUM(4.0)
...
```
TD14M08  "DURATION (IN SECONDS) 14"              NUM(5.0)
...
TD14M10  "INTENDED AUDIENCE 14"                NUM(1.0)
...
```
TD14M14  "SCIENCE FICTION/FANTASY/SUPERNATURAL 14"       NUM(1.0)
...
for adults. Examples: Property Brothers, Diners DriveIns and Dives, Destination Food.]
...
```
TD14M17  "COMPETITIVE ELEMENT 14"               NUM(1.0)
...
```
TD14M18  "ONLINE ONLY CONTENT 14"               NUM(1.0)

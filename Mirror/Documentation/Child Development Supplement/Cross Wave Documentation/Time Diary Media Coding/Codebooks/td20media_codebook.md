# **2020: Child Development** **Supplement - Time Diary Media** **Codes File** **Codebook**
...
```
    Monday August 22 2022 3:48 PM

```

```
        2020: Child Development Supplement - Time Diary Media Codes File

TD20M01  "TD CONTENT CODING RELEASE NUMBER 20"         NUM(1.0)

Release number for the CDS-20 Time Diary Media Content Coding Data File
...
```
TD20M02  "2019 PSID FAMILY IW (ID) NUMBER"           NUM(5.0)
...
```
TD20M03  "2019 INDIVIDUAL SEQUENCE NUMBER"           NUM(2.0)
...
```
TD20M04  "TYPE OF DIARY 20"                  NUM(1.0)
...
TD20M07  "ACTIVITY CODE 20"                  NUM(4.0)
...
```
TD20M08  "DURATION (IN SECONDS) 20"              NUM(5.0)
...
```
TD20M10  "INTENDED AUDIENCE 20"                NUM(1.0)
...
```
TD20M14  "SCIENCE FICTION/FANTASY/SUPERNATURAL 20"       NUM(1.0)
...
Count   %  Value/Range Code Value/Range Text
    ...
    500 36.66 1 Non-Violent / Non-Hostile [Does not directly show nor
...
```
TD20M17  "COMPETITIVE ELEMENT 20"               NUM(1.0)
...
```
TD20M18  "ONLINE ONLY CONTENT 20"               NUM(1.0)
